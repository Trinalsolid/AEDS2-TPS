...
class Jogador{
    ...
    public static void mostrar(){
        System.out.println("["+jogad[tamJog].getId()+" ## "+jogad[tamJog].getNome()+" ## "+jogad[tamJog].getAltura()+" ## "+jogad[tamJog].getPeso()
        +" ## "+ jogad[tamJog].getAnoNascimento()+" ## "+ jogad[tamJog].getUniversidade()+" ## "+jogad[tamJog].getCidadeNascimento()+
        " ## " +jogad[tamJog].getEstadoNascimento()+"]");
    }
